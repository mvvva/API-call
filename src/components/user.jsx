                    ...
                    <tbody>
                        {users?.map((item, index) => (
                            <tr key={index}>
                                ...
                                <td>{item.number}</td>
                                <td className="images">
                                    <MdEdit style={{ color: "blue", fontSize: "25", cursor: "pointer" }} onClick={() => handleEdit(item)} />
                                    <FaTrashAlt style={{ color: "red", fontSize: "25", cursor: "pointer" }} onClick={() => handleDelete(item.id)} />
                                </td>
                            </tr>
                        ))}
                    </tbody>
